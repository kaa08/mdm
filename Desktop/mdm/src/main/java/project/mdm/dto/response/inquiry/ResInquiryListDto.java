...
public class ResInquiryListDto {
    ...
    @Builder
    public ResInquiryListDto(Long inquiryId, LocalDate date, String title, String contents, String writerName, String writerEmail, Boolean replied, String createdDate, String modifiedDate) {
