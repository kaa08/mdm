...
public class MemberResponseDto {
    ...
    @Builder
    public MemberResponseDto(Long memberId, String email, String username, String password, String passwordCheck, String myName, String nickname, LocalDate birth, Integer driveExp) {
